...
public class MainClient {
	...
	//HINT: TIPS ON HOW TO WRITE TESTS WITH JUNIT4 AND JUNIT5 (AND LOGGING) CAN BE FOUND AT TIPPS AND TRICKS FORUM ENTRY
	//ON TESTING/LOGGING ON MOODLE! THOSE WILL BE AVAILABLE AFTER THE RESPECTIVE TUTORIAL SESSIONS.
	...
	public static void main(String[] args) {
		 ...
		 *  
		 *  HINT: The tips and tricks section in Moodle also explains all the important aspects about the start parameters/arguments.
		...
		// always check for errors, and if some are reported at least print them to the console 
		...
		if(resultReg.getState() == ERequestState.Error) {
			...
			System.out.print("My Player ID:"+uniqueID.getUniquePlayerID());
		}
	...
	public static void exampleForGetRequests() throws Exception	{
		...
		//TIP: Use a global instance of the base webclient throughout each communication
		//you can init it once in the CTOR and use it in each of the network communication methods in your networking class
